...
{
$updated = $db->delete( 'newscategory', array('cid' =>$_REQUEST['delete']));
...
$updated = $db->delete( 'newscategory', array('cid' =>$value));
$msg= '<div class="alert alert-success"><button class="close" data-dismiss="alert">&times;</button><strong>Success!</strong> Delete Successfully</div>';
}
}
?>
...
{
$updated = $db->update( 'newscategory', array('cStatus' => 'Enable'),array('cid' =>$_GET['unp_id']));
}
if(isset($_GET['p_id']) && $_GET['p_id']!='')
{
$updated = $db->update( 'newscategory', array('cStatus' => '0'),array('cid' =>$_GET['p_id']));
}
?>
<!-- STATUS  -->
<!DOCTYPE html>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-black">
          <div class="box-title">
            <h3><i class="fa fa-table"></i>Categories</h3>
              ...
              <!--  <br>
                ...
                <ul id="pagebox" style="list-style:none; padding:0; margin:0;">
                  <?php
					...
					$sql = "SELECT * FROM newscategory WHERE cIsactive = 1 ".$Filter." ORDER BY corder ASC  ";
                  ...
                  <li id="recordsArray_<?php echo $get['cid'];?>" style="cursor:move">
                    <table class="table table-advance" style=" padding:0; margin-bottom:5px;">
                      <tr class="table-flag-blue">
                        ...
                        <td  width="100"><?php if($get['cStatus']=='Enable'){ echo '<a href="ncategory.php?p_id='.$get['cid'].'"><span class="badge badge-success">Enable</span></a>';}else{echo'<a href="ncategory.php?unp_id='.$get['cid'].'"><span class="badge badge-important">Disable</span></a>';} ?>
                        </td>
                        <td  width="100"><a href="<?php echo APPC_URL; ?>update-ncategory.php?ref=<?php echo $get['cid']; ?>" class="btn btn-primary btn-sm" title="Edit"><i class="fa fa-edit"></i> </a> <a onClick="return confirm('Are you sure you want to Delete?')" href="<?php echo APPC_URL; ?>ncategory.php?delete=<?php echo $get['cid']; ?>" class="btn btn-danger btn-sm" title="Delete"><i class="fa fa-trash-o"></i> </a> </td>
                      </tr>
                      </tbody>
...
$(document).ready(function(){ 
	$(function() {
		...
		var order = $(this).sortable("serialize") + '&action=updateRecordsListings'; 
			$.post("newcategoryupdate.php", order, function(theResponse){
			}); 															 
		}								  
		});
	});
