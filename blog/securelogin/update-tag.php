...
if($cName != '') {
$checkExists = $db->num_rows("SELECT cUrl FROM tags WHERE cUrl = '".$cUrl."' AND cid != '".$_GET['ref']."' ");
if($checkExists==0){
if(isset($cStatus) && $cStatus=='Enable'){$cStatus='Enable';}else{$cStatus='Disable';} 
$update = $db->update('tags',array('cUrl'=>$f->seourl($cUrl),'cName' => $cName,'cStatus'=>$cStatus),array('cid'=>$_GET['ref']));
...
<div class="container" id="main-container">
  ...
  <div id="main-content">
    ...
    <div class="page-title">
      <div>
        <h1><i class="fa fa-list"></i> Update Tag</h1>
      </div>
    </div>
    <!-- END Page Title -->
    <!-- BEGIN Breadcrumb -->
    ...
    <?php $get=$db->get_row("Select * from tags where cid='".$_REQUEST['ref']."'"); ?>
    <div class="row">
      <div class="col-md-12">
        <div class="box box-black">
          <div class="box-title">
            <h3><i class="fa fa-bars"></i>Update Tag</h3>
            ...
            <form action="" class="form-horizontal form-bordered form-row-stripped" method="post" enctype="multipart/form-data" onSubmit="return Validate(this);">
              <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-10 controls">
                  <input type="text" name="cName" id="cName" class="form-control" value="<?php echo $get['cName']; ?>" required>
                </div>
              </div>
              <div class="form-group">
                <label for="password5" class="col-sm-3 col-lg-2 control-label">URL</label>
                <div class="col-sm-9 col-lg-10 controls">
                  <input type="text" name="cUrl" id="cUrl" class="form-control" value="<?php echo $get['cUrl']; ?>" required>
                </div>
              </div>
              <div class="form-group">
