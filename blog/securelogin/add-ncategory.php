...
if($cName!= '') {
$cUrl=$f->seourl($cName);
$checkExists = $db->num_rows("SELECT cUrl FROM newscategory WHERE cUrl = '".$cUrl."'");
if($checkExists==0){
$num= $db->num_rows("SELECT corder FROM newscategory");
$corder=$num+1;
$add_query = $db->insert('newscategory',array('cUrl'=>$cUrl,'cName' => $cName,'corder'=>$corder));
...
<div class="container" id="main-container">
  ...
  <div id="main-content">
    ...
    <div class="page-title">
      <div>
        <h1><i class="fa fa-list"></i> Add New Category</h1>
      </div>
    </div>
    <!-- END Page Title -->
    <!-- BEGIN Breadcrumb -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-black">
          <div class="box-title">
            <h3><i class="fa fa-bars"></i> Add New Category</h3>
